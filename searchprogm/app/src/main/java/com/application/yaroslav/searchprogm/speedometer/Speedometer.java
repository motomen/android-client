package com.application.yaroslav.searchprogm.speedometer;
...
import com.application.yaroslav.searchprogm.R;
...
public class Speedometer extends View implements SpeedChangeListener {
    ...
    public static final float DEFAULT_MAX_SPEED = 11; // Assuming this is km/h and you drive a super-car
    ...
    private int SCALE_COLOR = Color.argb(255, 0, 255, 0);
...
//		Log.d(TAG, "Height spec: " + MeasureSpec.toString(heightMeasureSpec));
    ...
    private void drawLegend(Canvas canvas){
        ...
        for(int i = 0; i < this.mMaxSpeed; i += increments){
            ...
            if (i <= 1) {
                scalePaint.setColor(Color.rgb(84, 181, 73));
            }
            if (i == 2) {

                scalePaint.setColor(Color.rgb(126, 197, 120));
            }

            if (i == 3) {
                scalePaint.setColor(Color.rgb(177, 211, 115));
            }

            if (i == 4) {
                scalePaint.setColor(Color.rgb(232, 232, 101));
            }

            if (i == 5) {
                scalePaint.setColor(Color.rgb(249, 222, 87));
            }

            if (i == 6) {
                scalePaint.setColor(Color.rgb(247, 196, 92));
            }

            if (i == 7) {
                scalePaint.setColor(Color.rgb(247, 167, 95));
            }

            if (i == 8) {
                scalePaint.setColor(Color.rgb(247, 152, 97));
            }

            if (i == 9) {
                scalePaint.setColor(Color.rgb(239, 103, 97));
            }

            if (i == 10) {
                scalePaint.setColor(Color.rgb(237, 71, 79));
            }
    ...
    private void drawReading(Canvas canvas){
        ...
        if (this.mCurrentSpeed <= 1.0) {
            readingPaint.setColor(Color.rgb(84, 181, 73));
        }

        if (this.mCurrentSpeed == 2.0) {
            readingPaint.setColor(Color.rgb(126, 197, 120));
        }

        if (this.mCurrentSpeed == 3.0) {
            readingPaint.setColor(Color.rgb(177, 211, 115));
        }

        if (this.mCurrentSpeed == 4.0) {
            readingPaint.setColor(Color.rgb(232, 232, 101));
        }

        if (this.mCurrentSpeed == 5.0) {
            readingPaint.setColor(Color.rgb(249, 222, 87));
        }

        if (this.mCurrentSpeed == 6.0) {
            readingPaint.setColor(Color.rgb(247, 196, 92));
        }

        if (this.mCurrentSpeed == 7.0) {
            readingPaint.setColor(Color.rgb(247, 167, 95));
        }

        if (this.mCurrentSpeed == 8.0) {
            readingPaint.setColor(Color.rgb(247, 152, 97));
        }

        if (this.mCurrentSpeed == 9.0) {
            readingPaint.setColor(Color.rgb(239, 103, 97));
        }

        if (this.mCurrentSpeed == 10.0) {
            readingPaint.setColor(Color.rgb(237, 71, 79));
        }
